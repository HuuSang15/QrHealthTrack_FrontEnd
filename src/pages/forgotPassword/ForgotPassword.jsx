...
function ForgetPassword() {
  ...
  return (
    <div className=" flex  items-center h-screen w-full bg-gradient-to-b from-blue-500 via-transparent to-transparent ">
        ...
        <div className="mx-20">
          ...
          <form action="" onSubmit={(e) => handleSubmit(e)} className="mt-14">
            ...
            <p className="text-center m-5 leading-6 text-sm font-semibold">
                Trở Về 
                <Link to="/login" className=" text-sm text-primaryColor font-bold hover:opacity-80"> Đăng Nhập 
