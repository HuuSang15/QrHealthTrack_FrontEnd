...
const PieChart = () => {
      ...
      tooltip: {
        callbacks: {
          label: (tooltipItem) => {
            ...
            const percent = ((dataset.data[tooltipItem.index] / total) * 100).toFixed(2);
  ...
  return (
    <div style={{ textAlign: 'center', width: '250px', height: '250px', margin: 'auto' }}>
      <h2 style={{fontWeight:"600",color: '#333333', marginBottom: '10px', fontSize: '16px' }}>Theo Dõi Lượng Máu</h2>
      <Doughnut data={data} options={options} width={200} height={200} />
      <div style={{ textAlign: 'center', marginTop: '-20px' }}>
        <p style={{ color:"#333",fontWeight: 'bold', fontSize: '16px',marginTop:"1rem" }}>Tổng Số Máu</p>
      </div>
    </div>
  );
};
