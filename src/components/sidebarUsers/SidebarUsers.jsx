...
const SidebarUsers = () => {
    return (
        <div className='pl-10 w-[400px] flex-none bg-[#F6F9F9] shadow-md'>
            <div className='flex items-center gap-4'>
                <div>
                    <img src="https://img.thuthuattinhoc.vn/uploads/2020/05/30/hhinh-anh-luffy-chibi-thu-the-rat-ngau_055520104.jpg" alt="avatar" className='w-20 h-20 object-cover rounded-full border-2 border-grey'/>
                </div>
